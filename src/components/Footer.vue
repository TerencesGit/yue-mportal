...
<script>
	export default {
		methods: {
			linkPhoto () {
				this.$router.push('/detail/photography')
			},
			linkTourism () {
				this.$router.push('/detail/tourism')
			},
			linkFinance () {
				this.$router.push('/detail/finance')
			},
			linkSystem () {
				this.$router.push('/detail/system')
			},
			linkMarketing () {
				this.$router.push('/detail/marketing')
			},
			linkJoin () {
				this.$router.push('/detail/join')
			},
			backHome () {
				this.$router.push('/')
			},
