			...
			<div class="login-box">
				...
				<div class="login-content">
					...
					<form action="#" onsubmit="return false">
						...
						<div class="form-group">
							<mt-button native-type="submit" type="primary" @click="submitForm" :loading="loading">登 录</mt-button>
						</div>
					</form>
					<!-- <div class="login-tip">
...
<style scoped lang="scss">
	.login-bg {
		...
		height: 100vh;
		padding: 30px;
		background: url(../../assets/img/login/login_bg.jpg) no-repeat center;
		...
		.auto-login {
			...
			.checkbox {
				...
				&.checked::before {
					...
					top: 0;
					left: 0;
					background: url(../../assets/img/login/arrow_success.png) no-repeat center;
				}
			}
		}
		.forget {
